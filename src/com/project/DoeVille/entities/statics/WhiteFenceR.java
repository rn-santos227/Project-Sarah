...
public class WhiteFenceR extends StaticEntity {
	private float x, y;
	public WhiteFenceR(Handler handler, float x, float y) {
	...
	public void render(Graphics g) {
		g.drawImage(Assets.WhiteFence[4], (int)(x - handler.getGameCamera().getxOffset()),(int)(y - handler.getGameCamera().getyOffset()), width, height, null);		
	}
	...
	@Override
	public Entity clone() {
		Entity e = new WhiteFenceR(handler, x, y);
		return e;
	}
