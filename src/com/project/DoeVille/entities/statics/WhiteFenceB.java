...
public class WhiteFenceB extends StaticEntity {
	private float x, y;
	public WhiteFenceB(Handler handler, float x, float y) {
	...
	public void render(Graphics g) {
		g.drawImage(Assets.WhiteFence[6], (int)(x - handler.getGameCamera().getxOffset()),(int)(y - handler.getGameCamera().getyOffset()), width, height, null);
	}
	...
	@Override
	public Entity clone() {
		Entity e = new WhiteFenceB(handler, x, y);
		return e;
	}
