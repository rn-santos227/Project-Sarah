...
public class WhiteFenceBR extends StaticEntity {
	private float x, y;
	public WhiteFenceBR(Handler handler, float x, float y) {
	...
	public void render(Graphics g) {
		g.drawImage(Assets.WhiteFence[7], (int)(x - handler.getGameCamera().getxOffset()),(int)(y - handler.getGameCamera().getyOffset()), width, height, null);		
	}
	...
	@Override
	public Entity clone() {
		Entity e = new WhiteFenceBR(handler, x, y);
		return e;
	}
