...
public class Wall01L1 extends StaticEntity {
	private MapAssignment map;
	private float x, y;
	public Wall01L1(Handler handler, float x, float y, MapAssignment mapAssignment) {
	...
	public void render(Graphics g) {
		g.drawImage(Assets.Wall01[1], (int)(x - handler.getGameCamera().getxOffset()),(int)(y - handler.getGameCamera().getyOffset()), width, height, null);	
	}
	...
	@Override
	public Entity clone() {
		Entity e = new Wall01L1(handler, x, y, map);
		return e;
	}
