...
public class Wall01TR extends StaticEntity {
	private MapAssignment map;
	private float x, y;
	public Wall01TR(Handler handler, float x, float y, MapAssignment mapAssignment) {
	...
	public void render(Graphics g) {
		g.drawImage(Assets.Wall01[10], (int)(x - handler.getGameCamera().getxOffset()),(int)(y - handler.getGameCamera().getyOffset()), width, height, null);		
	}
	...
	@Override
	public Entity clone() {
		Entity e = new Wall01TR(handler, x, y, map);
		return e;
	}
