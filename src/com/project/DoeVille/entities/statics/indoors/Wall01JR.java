...
public class Wall01JR extends StaticEntity {
	private MapAssignment map;
	private float x, y;
	public Wall01JR(Handler handler, float x, float y, MapAssignment mapAssignment) {
	...
	public void render(Graphics g) {
		g.drawImage(Assets.Wall01[12], (int)(x - handler.getGameCamera().getxOffset()),(int)(y - handler.getGameCamera().getyOffset()), width, height, null);	
	}
	...
	@Override
	public Entity clone() {
		Entity e = new Wall01JR(handler, x, y, map);
		return e;
	}
