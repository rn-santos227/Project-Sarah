...
public class WoodCounterA2 extends Entity {
	private MapAssignment map;
	private float x, y;
	public WoodCounterA2(Handler handler, float x, float y, MapAssignment mapAssignment) {
	...
	public void render(Graphics g) {
		g.drawImage(Assets.WoodenCounterA[2], (int)(x - handler.getGameCamera().getxOffset()),(int)(y - handler.getGameCamera().getyOffset()), width, height, null);	
	}
	...
	public Entity clone() {
		Entity e = new WoodCounterA2(handler, x, y, map);
		return e;
	}
