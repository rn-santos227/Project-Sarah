...
public class CafeteriaCounterA4 extends Entity {
	private MapAssignment map;
	private float x, y;
	public CafeteriaCounterA4(Handler handler, float x, float y, MapAssignment mapAssignment) {
	...
	public void render(Graphics g) {
		g.drawImage(Assets.CafeteriaCounterA[4], (int)(x - handler.getGameCamera().getxOffset()),(int)(y - handler.getGameCamera().getyOffset()), width, height, null);	
	}
	...
	public Entity clone() {
		Entity e = new CafeteriaCounterA4(handler, x, y, map);
		return e;
	}
