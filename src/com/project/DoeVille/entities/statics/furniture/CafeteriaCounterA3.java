...
public class CafeteriaCounterA3 extends Entity {
	private MapAssignment map;
	private float x, y;
	public CafeteriaCounterA3(Handler handler, float x, float y, MapAssignment mapAssignment) {
	...
	public void render(Graphics g) {
		g.drawImage(Assets.CafeteriaCounterA[3], (int)(x - handler.getGameCamera().getxOffset()),(int)(y - handler.getGameCamera().getyOffset()), width, height, null);	
	}
	...
	public Entity clone() {
		Entity e = new CafeteriaCounterA3(handler, x, y, map);
		return e;
	}
