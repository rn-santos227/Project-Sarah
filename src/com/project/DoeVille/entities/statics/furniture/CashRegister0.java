...
public class CashRegister0 extends Entity {
	private MapAssignment map;
	private float x, y;
	public CashRegister0(Handler handler, float x, float y, MapAssignment mapAssignment) {
	...
	public void render(Graphics g) {
		g.drawImage(Assets.CashRegister[0], (int)(x - handler.getGameCamera().getxOffset()),(int)(y - handler.getGameCamera().getyOffset()), width, height, null);		
	}
	...
	public Entity clone() {
		Entity e = new CashRegister0(handler, x, y, map);
		return e;
	}
