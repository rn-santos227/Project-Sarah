...
public class CafeteriaBox1 extends Entity {
	private MapAssignment map;
	private float x, y;
	public CafeteriaBox1(Handler handler, float x, float y, MapAssignment mapAssignment) {
	...
	public void render(Graphics g) {
		g.drawImage(Assets.CafeteriaBox[1], (int)(x - handler.getGameCamera().getxOffset()),(int)(y - handler.getGameCamera().getyOffset()), width, height, null);		
	}
	...
	public Entity clone() {
		Entity e = new CafeteriaBox1(handler, x, y, map);
		return e;
	}
