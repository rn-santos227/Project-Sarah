...
public class KeyBox extends Entity {
	private MapAssignment map;
	private float x, y;
	public KeyBox(Handler handler, float x, float y, MapAssignment mapAssignment) {
	...
	public void render(Graphics g) {
		g.drawImage(Assets.KeyBox, (int)(x - handler.getGameCamera().getxOffset()),(int)(y - handler.getGameCamera().getyOffset()), width, height, null);		
	...
	public Entity clone() {
		Entity e = new KeyBox(handler, x, y, map);
		return e;
	}
