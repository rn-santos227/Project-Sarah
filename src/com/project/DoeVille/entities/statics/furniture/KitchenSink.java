...
public class KitchenSink extends Entity {
	private MapAssignment map;
	private float x, y;
	public KitchenSink(Handler handler, float x, float y, MapAssignment mapAssignment) {
	...
	public void render(Graphics g) {
		g.drawImage(Assets.KitchenSink, (int)(x - handler.getGameCamera().getxOffset()),(int)(y - handler.getGameCamera().getyOffset()), width, height, null);	
	}
	...
	public Entity clone() {
		Entity e = new KitchenSink(handler, x, y, map);
		return e;
	}
