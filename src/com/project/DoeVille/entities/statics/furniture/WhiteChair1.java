...
public class WhiteChair1 extends Entity {
	private MapAssignment map;
	private float x, y;
	public WhiteChair1(Handler handler, float x, float y, MapAssignment mapAssignment) {
	...
	public void render(Graphics g) {
		g.drawImage(Assets.WChair[1], (int)(x - handler.getGameCamera().getxOffset()),(int)(y - handler.getGameCamera().getyOffset()), width, height, null);		
	...
	public Entity clone() {
		Entity e = new WhiteChair1(handler, x, y, map);
		return e;
	}
