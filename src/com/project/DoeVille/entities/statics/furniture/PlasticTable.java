...
public class PlasticTable extends Entity {
	private MapAssignment map;
	private float x, y;
	public PlasticTable(Handler handler, float x, float y, MapAssignment mapAssignment) {
	...
	public void render(Graphics g) {
		g.drawImage(Assets.PlasticTable, (int)(x - handler.getGameCamera().getxOffset()),(int)(y - handler.getGameCamera().getyOffset()), width, height, null);	
	...
	public Entity clone() {
		Entity e = new PlasticTable(handler, x, y, map);
		return e;
	}
