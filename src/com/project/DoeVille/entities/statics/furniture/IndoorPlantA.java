...
public class IndoorPlantA extends Entity {
	...
	public void render(Graphics g) {
		g.drawImage(Assets.IndoorPlantA, (int)(x - handler.getGameCamera().getxOffset()),(int)(y - handler.getGameCamera().getyOffset()), width, height, null);		
	...
	public Entity clone() {
		Entity e = new IndoorPlantA(handler, x, y, map);
		return e;
	}
