...
public class WhiteFenceTL extends StaticEntity {
	private float x, y;
	public WhiteFenceTL(Handler handler, float x, float y) {
	...
	public void render(Graphics g) {
		g.drawImage(Assets.WhiteFence[0], (int)(x - handler.getGameCamera().getxOffset()),(int)(y - handler.getGameCamera().getyOffset()), width, height, null);				
	}
	...
	@Override
	public Entity clone() {
		Entity e = new WhiteFenceTL(handler, x, y);
		return e;
	}
