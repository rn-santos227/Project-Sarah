...
public class Sarah extends DynamicEntity {
	...
	public Sarah(Handler handler, HUD hud, DisplayDialog dd, float x, float y) {
		super(handler, x, y, DynamicEntity.DEFAULT_W, (DynamicEntity.DEFAULT_H) * 2, EntityID.NonPlayable, MapAssignment.Map000);
		...
		eating = new Animation(500, Assets.player_F_eating);
	}
	...
	public void render(Graphics g) {
		g.drawImage(eating.getCurrentFrame(), (int)(x - handler.getGameCamera().getxOffset()),(int)(y - handler.getGameCamera().getyOffset()), width, height, null);
	}
	...
	public void examine() {
		...
		dd.getNpcBox();
		NPCDialog.NPCName = "Sarah";
		
		Player.dID = DialogID.npc;
		ran = new Random();
		messageID = ran.nextInt(5);
		loadScript.runScript("getNPCDialog000", this);
	...
	public Entity clone() {
		Entity e = new Sarah(handler, hud, dd, x, y);
		return e;
	}
