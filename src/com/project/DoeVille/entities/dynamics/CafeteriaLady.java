...
public class CafeteriaLady extends DynamicEntity {
	...
	public CafeteriaLady(Handler handler, HUD hud, DisplayDialog dd, float x, float y) {
		...
		NPCfacing = Assets.CafeteriaLady[0];
	}
	...
	public void examine() {
		...
		dd.getNpcBox();
		NPCDialog.NPCName = "Cafeteria Lady";
	...
	public Entity clone() {
		Entity e = new CafeteriaLady(handler, hud, dd, x, y);
		return e;
	}
