...
public class PharmacyDoor extends Entity {
	private HUD hud;
	private DisplayDialog dd;
	private float x, y;
	public PharmacyDoor(Handler handler, HUD hud, DisplayDialog dd, float x, float y) {
	...
	public Entity clone() {
		Entity e = new PharmacyDoor(handler, hud, dd, x, y);
		return e;
	}
}
