...
public class ToBathroom extends Entity {
	private DisplayDialog dd;
	private float x, y;
	public ToBathroom(Handler handler, float x, float y, MapAssignment mapAssignment) {
	...
	public void render(Graphics g) {
		g.drawImage(Assets.Doors[2], (int)(x - handler.getGameCamera().getxOffset()),(int)(y - handler.getGameCamera().getyOffset()), width, height, null);
	...
	public Entity clone() {
		Entity e = new ToBathroom(handler, x, y, mapAssignment);
		return e;
	}
