...
public class InformationDialog extends DialogUtil {
	...
	public InformationDialog(Handler handler) {
	...
	public void render(Graphics g) {
		...
		g.drawString("Examine:", ((640 / 2) - (32 * 3)) + 15, 35);
		drawString(g, content, ((640 / 2) - (32 * 3)) + 30, 52, 180);
		if(endPrint) {
