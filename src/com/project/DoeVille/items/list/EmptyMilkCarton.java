...
public class EmptyMilkCarton extends Item {
	protected Handler handler;
	protected HUD hud;
	protected String Description;
		
	public EmptyMilkCarton(Handler handler, HUD hud, float x, float y) {
		super(ItemAssets.Milk_A, x, y, "Empty Carton", 4, ItemCategory.Equipment, false, false, false, true);
		this.handler = handler; this.hud = hud;
		loadScript = new LoadScript("Dialogues.lua");
		loadScript.runScript("getItemDescription004", this);
	}
