...
public class Snack1 extends Item {
	protected Handler handler;
	protected HUD hud;
	protected String Description;
	protected String Message;
		
	public Snack1(Handler handler, HUD hud, float x, float y) {
		super(ItemAssets.Snacks[1], x, y, "White Chocolate Bar", 26, ItemCategory.Consumable, true, false, false, true);
		this.handler = handler; this.hud = hud;
		loadScript = new LoadScript("Dialogues.lua");
		loadScript.runScript("getItemDescription026", this);
	}
