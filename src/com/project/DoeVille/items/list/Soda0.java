...
public class Soda0 extends Item {
	protected Handler handler;
	protected HUD hud;
	protected String Description;
	protected String Message;
		
	public Soda0(Handler handler, HUD hud, float x, float y) {
		super(ItemAssets.SodaCans[0], x, y, "Lime Soda Can", 17, ItemCategory.Consumable, true, false, false, true);
		this.handler = handler; this.hud = hud;
		loadScript = new LoadScript("Dialogues.lua");
		loadScript.runScript("getItemDescription017", this);
	}
