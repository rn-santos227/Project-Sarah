...
public class BottledDrinks1 extends Item {
	protected Handler handler;
	protected HUD hud;
	protected String Description;
	protected String Message;
		
	public BottledDrinks1(Handler handler, HUD hud, float x, float y) {
		super(ItemAssets.BottledDrinks[1], x, y, "Bottled Chocolate", 23, ItemCategory.Consumable, true, false, false, true);
		this.handler = handler; this.hud = hud;
		loadScript = new LoadScript("Dialogues.lua");
		loadScript.runScript("getItemDescription023", this);
	}
