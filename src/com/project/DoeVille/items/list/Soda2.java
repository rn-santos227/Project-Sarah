...
public class Soda2 extends Item {
	protected Handler handler;
	protected HUD hud;
	protected String Description;
	protected String Message;
		
	public Soda2(Handler handler, HUD hud, float x, float y) {
		super(ItemAssets.SodaCans[2], x, y, "Orange Soda Can", 19, ItemCategory.Consumable, true, false, false, true);
		this.handler = handler; this.hud = hud;
		loadScript = new LoadScript("Dialogues.lua");
		loadScript.runScript("getItemDescription019", this);
	}
	...
	public void use() {
		...
		Item item = new EmptyCanA(handler, ItemAssets.SodaCans[2], hud, 0, 0);
