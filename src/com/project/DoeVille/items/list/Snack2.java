...
public class Snack2 extends Item {
	protected Handler handler;
	protected HUD hud;
	protected String Description;
	protected String Message;
		
	public Snack2(Handler handler, HUD hud, float x, float y) {
		super(ItemAssets.Snacks[2], x, y, "Caramel Bar", 27, ItemCategory.Consumable, true, false, false, true);
		this.handler = handler; this.hud = hud;
		loadScript = new LoadScript("Dialogues.lua");
		loadScript.runScript("getItemDescription027", this);
	}
