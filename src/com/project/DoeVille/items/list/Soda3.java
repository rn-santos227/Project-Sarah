...
public class Soda3 extends Item {
	protected Handler handler;
	protected HUD hud;
	protected String Description;
	protected String Message;
		
	public Soda3(Handler handler, HUD hud, float x, float y) {
		super(ItemAssets.SodaCans[3], x, y, "Grape Soda Can", 20, ItemCategory.Consumable, true, false, false, true);
		this.handler = handler; this.hud = hud;
		loadScript = new LoadScript("Dialogues.lua");
		loadScript.runScript("getItemDescription020", this);
	}
	...
	public void use() {
		...
		Item item = new EmptyCanA(handler, ItemAssets.SodaCans[3], hud, 0, 0);
