...
public class Snack5 extends Item {
	protected Handler handler;
	protected HUD hud;
	protected String Description;
	protected String Message;
		
	public Snack5(Handler handler, HUD hud, float x, float y) {
		super(ItemAssets.Snacks[5], x, y, "Bag of Cashew Nuts", 30, ItemCategory.Consumable, true, false, false, true);
