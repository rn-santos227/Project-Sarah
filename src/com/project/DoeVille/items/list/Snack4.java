...
public class Snack4 extends Item {
	protected Handler handler;
	protected HUD hud;
	protected String Description;
	protected String Message;
		
	public Snack4(Handler handler, HUD hud, float x, float y) {
		super(ItemAssets.Snacks[4], x, y, "Bag of Peanuts", 29, ItemCategory.Consumable, true, false, false, true);
		this.handler = handler; this.hud = hud;
		loadScript = new LoadScript("Dialogues.lua");
		loadScript.runScript("getItemDescription029", this);
	}
