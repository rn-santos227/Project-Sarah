...
public class Snack0 extends Item {
	protected Handler handler;
	protected HUD hud;
	protected String Description;
	protected String Message;
		
	public Snack0(Handler handler, HUD hud, float x, float y) {
		super(ItemAssets.Snacks[0], x, y, "Chocolate Bar", 25, ItemCategory.Consumable, true, false, false, true);
		this.handler = handler; this.hud = hud;
		loadScript = new LoadScript("Dialogues.lua");
		loadScript.runScript("getItemDescription025", this);
	}
