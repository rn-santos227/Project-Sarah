...
public class Snack3 extends Item {
	protected Handler handler;
	protected HUD hud;
	protected String Description;
	protected String Message;
		
	public Snack3(Handler handler, HUD hud, float x, float y) {
		super(ItemAssets.Snacks[3], x, y, "Granola Bar", 28, ItemCategory.Consumable, true, false, false, true);
		this.handler = handler; this.hud = hud;
		loadScript = new LoadScript("Dialogues.lua");
		loadScript.runScript("getItemDescription028", this);
	}
