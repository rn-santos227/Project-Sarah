...
public class Soda1 extends Item {
	protected Handler handler;
	protected HUD hud;
	protected String Description;
	protected String Message;
		
	public Soda1(Handler handler, HUD hud, float x, float y) {
		super(ItemAssets.SodaCans[1], x, y, "Rootbeer Can", 18, ItemCategory.Consumable, true, false, false, true);
		this.handler = handler; this.hud = hud;
		loadScript = new LoadScript("Dialogues.lua");
		loadScript.runScript("getItemDescription018", this);
	}
	...
	public void use() {
		...
		Item item = new EmptyCanA(handler, ItemAssets.SodaCans[1], hud, 0, 0);
