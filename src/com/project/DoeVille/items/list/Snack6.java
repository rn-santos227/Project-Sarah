...
public class Snack6 extends Item {
	protected Handler handler;
	protected HUD hud;
	protected String Description;
	protected String Message;
		
	public Snack6(Handler handler, HUD hud, float x, float y) {
		super(ItemAssets.Snacks[6], x, y, "Sponge Cake", 31, ItemCategory.Consumable, true, false, false, true);
		this.handler = handler; this.hud = hud;
		loadScript = new LoadScript("Dialogues.lua");
		loadScript.runScript("getItemDescription031", this);
	}
