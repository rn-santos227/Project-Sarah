...
public class BottledDrinks2 extends Item {
	protected Handler handler;
	protected HUD hud;
	protected String Description;
	protected String Message;
		
	public BottledDrinks2(Handler handler, HUD hud, float x, float y) {
		super(ItemAssets.BottledDrinks[2], x, y, "Bottled Orange", 24, ItemCategory.Consumable, true, false, false, true);
		this.handler = handler; this.hud = hud;
		loadScript = new LoadScript("Dialogues.lua");
		loadScript.runScript("getItemDescription024", this);
	}
